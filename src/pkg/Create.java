...
public class Create {
	...
	public void createCard() {
		...
		JPanel main = new JPanel(new BorderLayout());frame1.add(main);
		...
		south.add(done);south.add(submit);
		north.add(labelForSender);north.add(sender);
		center.add(labelForGift);center.add(gift);center.add(labelForName);center.add(name);
